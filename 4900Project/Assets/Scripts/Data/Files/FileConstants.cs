...
namespace FileConstants
{
    ...
    public static class Files
    {
        ...
        public static readonly FileStorageData Dialog = new FileStorageData()
        {
            ...
            LocalBackupFile = $"{Application.dataPath}/Resources/BackupData/Dialog.csv"
        };
        ...
        public static readonly FileStorageData Items = new FileStorageData()
        {
            ...
            LocalBackupFile = $"{Application.dataPath}/Resources/BackupData/Items.csv"
        };
        ...
        public static readonly FileStorageData Town = new FileStorageData()
        {
            ...
            LocalBackupFile = $"{Application.dataPath}/Resources/BackupData/Town.csv"
        };
        ...
        public static readonly FileStorageData Tutorial = new FileStorageData()
        {
            ...
            LocalBackupFile = $"{Application.dataPath}/Resources/BackupData/Tutorial.csv"
        };
        ...
        public static readonly FileStorageData MapNodes = new FileStorageData()
        {
            ...
            LocalBackupFile = $"{Application.dataPath}/Resources/BackupData/MapNodes.csv"
        };
        ...
        public static readonly FileStorageData MapEdges = new FileStorageData()
        {
            ...
            LocalBackupFile = $"{Application.dataPath}/Resources/BackupData/MapEdges.csv"
        };
        ...
        public static readonly FileStorageData TestCsv = new FileStorageData()
        {
            ...
            LocalBackupFile = $"{Application.dataPath}/Resources/BackupData/Tests/TestFile.csv"
        };
        ...
        public static readonly FileStorageData TestBasicJson = new FileStorageData()
        {
            ...
            LocalBackupFile = $"{Application.dataPath}/Resources/BackupData/Tests/BasicJson.json"
        };
        ...
        public static readonly FileStorageData TestJsonStringsList = new FileStorageData()
        {
            ...
            LocalBackupFile = $"{Application.dataPath}/Resources/BackupData/Tests/StringList.json"
        };
        ...
        public static readonly FileStorageData TestJsonListOfClass = new FileStorageData()
        {
            ...
            LocalBackupFile = $"{Application.dataPath}/Resources/BackupData/Tests/ListOfClass.json"
        };
